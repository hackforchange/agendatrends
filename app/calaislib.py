...
class Calais():
	...
	"""
	api_key = None
	processing_directives = {"contentType":"TEXT/RAW", "outputFormat":"application/json", "reltagBaseURL":None, "calculateRelevanceScore":"true", "enableMetadataType":"GenericRelations,SocialTags", "discardMetadata":None, "omitOutputtingOriginalText":"true"}
